...
```
cd existing_repo
git remote add origin https://gitlab.com/join.tecnologia/projeto-base-phpreact-web.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/join.tecnologia/projeto-base-phpreact-web/-/settings/integrations)
